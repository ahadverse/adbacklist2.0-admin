    ...
    const fetchPosts = async () => {
      ...
      try {
        const res = await baseApi.get(
          `/posts?isApproved=true&page=${pagination.page}&limit=${pagination.limit}&q=${search}&sortOrder=${sortOrder}&date=${date}&cat=${category}&subCat=${subcategory}`
        );
